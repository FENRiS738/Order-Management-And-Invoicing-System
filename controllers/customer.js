...
import { customer_template, order_form_template, error_template } from "../views/index.js";
...
const getCustomer = async (id) => {
    try {
        ...
        return { message: 'Failed to get customer data. Please try again later.' }
    }
};
...
const getCustomerData = async (req, res) => {
    try {
        ...
        if (customer_id === null || customer_id === "") {
            return res.send(error_template({ message: "Please enter a valid customer id." }))
        }
